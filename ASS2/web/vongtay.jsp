...
<head>
    ...
    <!-- Link tới nhan.css -->
    <link rel="stylesheet" href="<%= request.getContextPath()%>/css/vongtay.css">
</head>
<body>
    <!-- Header -->
    <header class="header-banner">
        ...
        <div class="banner-content">
            <h1>HELIOS</h1>
            <h2>VÒNG TAY - KHẲNG ĐỊNH SỰ KHÁC BIỆT</h2>
            <p>
    ...
    <main>
        ...
        <section class="product-grid">
            <div class="product">
                <img src="images/hunterskull1.png" alt="Vòng tay 1">
                <h4>Mafi Lotus Ring Helios Silver</h4>
                <p>Từ 1.250.000 VND</p>
            </div>
            <div class="product">
                <img src="assets/images/ring2.jpg" alt="Vòng tay 2">
                <h4>Roto Helios Black Silver</h4>
                <p>Từ 1.350.000 VND</p>
            </div>
            <div class="product">
                <img src="assets/images/ring3.jpg" alt="Vòng tay 3">
